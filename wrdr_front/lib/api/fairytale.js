...
export const requestMiddleSentence = text => {
  ...
  //     },
  //   );
  //   // console.log('원래꺼:', response.data.result.outputText);
  //   const result = response.data.result.outputText;
  //   const splitedText = result.split(/[!,?,.,:]/);

  //   console.log('splited: ', splitedText);
  //   console.log('splited: ', splitedText[0] + splitedText[1]);
  //   return splitedText[0] + splitedText[1];
  // } catch (e) {
  //   console.error('HYPERCLOVA MIDDLE API request fail: ', e);
  // }
};
